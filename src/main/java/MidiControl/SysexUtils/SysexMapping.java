...
public class SysexMapping {
  ...
  private long key; // precomputed key for faster lookup
  private int value;
  ...
  public List<Object> getParameter_change_format() {
    return parameter_change_format;
  }

  public List<Object> getParameter_request_format() {
    return parameter_request_format;
  }
}
