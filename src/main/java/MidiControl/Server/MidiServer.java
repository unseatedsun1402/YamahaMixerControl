...
import java.util.List; import java.util.concurrent.ConcurrentLinkedQueue; import java.util.logging.Level; import java.util.logging.Logger;
import javax.sound.midi.MidiMessage;
import org.apache.commons.math3.exception.OutOfRangeException;
import MidiControl.ContextModel.ControlSchema; import MidiControl.ContextModel.InputChannelStripViewBuilder; import MidiControl.ContextModel.ViewBuilder; import MidiControl.ControlServer.HardwareInputHandler; import MidiControl.Controls.CanonicalRegistry; import MidiControl.Controls.ControlInstance; import MidiControl.MidiDeviceManager.MidiIOManager; import MidiControl.MidiDeviceManager.TransportMode; import MidiControl.NrpnUtils.NrpnParser; import MidiControl.NrpnUtils.NrpnRegistry; import MidiControl.NrpnUtils.NrpnMapping; import MidiControl.NrpnUtils.NrpnMappingLoader; import MidiControl.SysexUtils.SysexMapping; import MidiControl.SysexUtils.SysexMappingLoader; import MidiControl.SysexUtils.SysexParser; import MidiControl.UserInterface.UiContextIndex; import MidiControl.UserInterface.UiModelFactory; import MidiControl.UserInterface.Frontend.GuiBroadcastListener; import MidiControl.UserInterface.Frontend.WebSocketGuiBroadcaster; import jakarta.annotation.PreDestroy;
public class MidiServer implements Runnable { private volatile boolean shutdownFlag = false; private final ConcurrentLinkedQueue<MidiMessage> inputBuffer = new ConcurrentLinkedQueue<>(); private final NrpnRegistry nrpnRegistry = new NrpnRegistry(); private final NrpnParser nrpnParser = new NrpnParser(); private final HardwareInputHandler inputHandler = new HardwareInputHandler(nrpnParser, nrpnRegistry); private final MidiIOManager deviceManager = new MidiIOManager(this); private final SubscriptionManager subscriptions; private final ControlSchema schema; private final ViewBuilder viewBuilder; private final UiContextIndex contextIndex; private final UiModelFactory uiFactory; private final ServerRouter router;
...
public MidiServer() {
    ...
    this.router = new ServerRouter(uiFactory, this, subscriptions);
