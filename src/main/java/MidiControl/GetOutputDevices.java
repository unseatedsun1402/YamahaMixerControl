 ...
 * @author ethanblood
 */
public class GetOutputDevices extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            {
                Logger.getLogger(GetOutputDevices.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public String getServletInfo() {
        return "This servlet returns a list of available midi output devices";
    }// </editor-fold>
