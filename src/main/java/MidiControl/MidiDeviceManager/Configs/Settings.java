...
public class Settings {
  ...
  public static void restore(MidiSettings settings) {
    if (settings == null) {
      logger.log(Level.WARNING, "Cannot restore devices — settings object is null.");
      return;
    }
  ...
  public static String getCurrentIOAsJson() {
    MidiDevice.Info inputInfo =
        MidiServer.midiIn != null ? MidiServer.midiIn.getDeviceInfo() : null;
    MidiDevice.Info outputInfo =
        MidiServer.midiOut != null ? MidiServer.midiOut.getDeviceInfo() : null;
